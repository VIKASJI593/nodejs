...
git commit -m "3-ExtendingToMultiplePages"

git push -u origin 3-ExtendingToMultiplePages

git push -f -u origin 3-ExtendingToMultiplePages
...
git branch -M 3-ExtendingToMultiplePages
